#PBS -S /bin/bash
#PBS -N ens_1deg_stage_2
#PBS -l select=4:ncpus=48:mpiprocs=4:ngpus=4:mem=437G:vntype=gpu
#PBS -l walltime=12:00:00
#PBS -o ens_1deg_stage_2.log
#PBS -e ens_1deg_stage_2_error.log
...
for NODE in $NODES; do
    ...
    ssh $NODE "
        ...
        /home/shp000/site8/conda/miniforge3/envs/paradis/bin/python train.py > output_1deg_stage_2.log \
            compute.num_nodes=4 \
